...
// NewDBConfig loads database Config values from environment variables.
// Variables names will be capitalized field names from the Config struct,
// prefixed with APP.
func NewDBConfig() (*DBConfig, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("error loading database configuration from "+
